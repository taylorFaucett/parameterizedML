...
def file_generate(root_file):
	...
	l_pt = root_export(root_file, 'xtt', 'l_pt')
	l_eta = root_export(root_file, 'xtt', 'l_eta')
	l_phi = root_export(root_file, 'xtt', 'l_phi')
	njet = root_export(root_file, 'xtt', 'njet')
	j1_pt = root_export(root_file, 'xtt', 'j1_pt')
	j1_eta = root_export(root_file, 'xtt', 'j1_eta')
	j1_phi = root_export(root_file, 'xtt', 'j1_phi')
	j1_b = root_export(root_file, 'xtt', 'j1_b')
	j2_pt = root_export(root_file, 'xtt', 'j2_pt')
	j2_eta = root_export(root_file, 'xtt', 'j2_eta')
	j2_phi = root_export(root_file, 'xtt', 'j2_phi')
	j2_b = root_export(root_file, 'xtt', 'j2_b')
	j3_pt = root_export(root_file, 'xtt', 'j3_pt')
	j3_eta = root_export(root_file, 'xtt', 'j3_eta')
	j3_phi = root_export(root_file, 'xtt', 'j3_phi')
	j3_b = root_export(root_file, 'xtt', 'j3_b')
	j4_pt = root_export(root_file, 'xtt', 'j4_pt')
	j4_eta = root_export(root_file, 'xtt', 'j4_eta')
	j4_phi = root_export(root_file, 'xtt', 'j4_phi')
	j4_b = root_export(root_file, 'xtt', 'j4_b')
	met = root_export(root_file, 'xtt', 'met')
	met_phi = root_export(root_file, 'xtt', 'met_phi')


	size = len(mx)
	data = np.zeros((size, 25))
...
def fixed_comparison_ROC():
	...
	plt.grid(True)
	plt.savefig('plots/fixed_%0.3f_ROC_plot.pdf' %fixed, dpi=400)
	plt.savefig('plots/images/fixed_%0.3f_ROC_plot.png' %fixed)
	plt.clf()
